    ...
    >
      <Link href={person.href} className="block no-underline">
        ...
        >
          ...
          {(
            [
              { pos: "top-3 left-3",     bTop: true,  bLeft: true  },
              { pos: "top-3 right-3",    bTop: true,  bRight: true },
              { pos: "bottom-3 left-3",  bBot: true,  bLeft: true  },
              { pos: "bottom-3 right-3", bBot: true,  bRight: true },
            ] as const
...
export default function Couple() {
  return (
    <section id="couple" className="py-28 px-8" style={{ backgroundColor: "#fff" }}>
      <SectionHeader
